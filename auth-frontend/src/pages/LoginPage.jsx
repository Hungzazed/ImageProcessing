...
export default function LoginPage() {
    ...
    return (
        <AuthSplitLayout
            image={loginImage}
            heroTitle="Tầm nhìn nghệ thuật."
            heroSubtitle="Trải nghiệm quyền năng của AI trong việc tái định nghĩa vẻ đẹp và sự hoàn mỹ trong từng khung hình."
        >
            <div className="mb-8 text-center lg:text-left">
                <p className="font-['Plus Jakarta Sans'] text-5xl font-extrabold tracking-[-0.04em] text-[#d2bbff] sm:text-6xl">
                    ĐĂNG NHẬP
                </p>
                <h1 className="mt-4 font-['Plus Jakarta Sans'] text-[30px] font-semibold leading-[38px] text-[#dae2fd]">
                    Chào mừng trở lại
                </h1>
                <p className="mt-2 text-[16px] leading-6 text-[#ccc3d8]">
                    Đăng nhập để tiếp tục sáng tạo những tác phẩm tuyệt đẹp
                </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                    <div className="mb-2 flex items-center justify-between gap-3">
                        <label className="block text-sm font-semibold text-[#ccc3d8]" htmlFor="password">
                            Mật khẩu
                        </label>
                        <Link className="text-xs font-medium text-[#d2bbff] transition-all hover:underline" to="/forgot-password">
                            Quên mật khẩu?
                        </Link>
                    </div>
            ...
            <div className="mt-6 text-center">
                <p className="text-sm text-[#ccc3d8]">
                    ...
                    <Link className="font-bold text-[#d2bbff] transition-all hover:underline" to="/register">
                        Đăng ký ngay
                    </Link>
                </p>
            </div>
